...
<script type="text/javascript">
	...
	function toSubmit(){
		 ...
		 if(!reg.test(email)){
			 document.getElementById("validateEmail").innerHTML="请输入22zhangsan-001_ss@gmail.com样式的邮箱";
			 submitForm = false;
		 }
		if(submitForm == true){
				...
				<tr>
					<td style="padding:30px">
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<input type="text" class="textinput" id="email"
									name="email" /></td>
								<td id="validateEmail" name="validateEmail"><font color="red">请输入有效的邮箱地址</font></td>
							</tr>
							<tr>
						...
						<table width="70%" border="0" cellspacing="0">
							<tr>
								<td style="padding-top:20px; text-align:center"><img
									 src="images/signup.gif"  border="0" onclick="toSubmit();">
								</td>
							</tr>
						</table></td>
				</tr>
