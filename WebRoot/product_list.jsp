			...
			<tr>
				...
				<td>
					<div style="text-align: right; margin: 5px 10px 5px 0px">
						<a href="index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;${pb.category} &nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;图书列表
					</div>
					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>${pb.category }</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pb.count }种商品
								<hr />
								...
								<div class="pagination">
									<ul>
										...
										<li class="disablepage"><a
											href="${pageContext.request.contextPath  }/showProductByPage?currentPage=${pb.currentPage==1?1:pb.currentPage-1}&category=${pb.category}">&lt;&lt;上一页</a>
										</li>
										...
										<li class="nextPage"><a
											href="${pageContext.request.contextPath  }/showProductByPage?currentPage=${pb.currentPage==pb.totalPage?pb.totalPage:pb.currentPage+1}&category=${pb.category}">&lt;&lt;下一页</a>
										</li>
