...
public class SendJMail {
		...
		String from = "duan_hang@foxmail.com"; 				//邮件发送人的邮件地址
		String to = email; 								//邮件接收人的邮件地址
		final String username = "duan_hang@foxmail.com";  	//发件人的邮件帐户
		final String password = "pscgrajmptiidieh";   		//发件人的邮件密码
		...
		//开启ssl加密 解决530 Error: A secure connection is requiered(such as ssl).
		...
		try {
			...
			//设置主题
			message.setSubject("Duann.的BookStore用户激活");
			//设置邮件的文本内容
